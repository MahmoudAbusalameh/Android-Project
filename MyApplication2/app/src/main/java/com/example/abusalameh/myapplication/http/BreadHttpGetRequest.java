...
import com.example.abusalameh.myapplication.menu.catlogfiles.BreadPart;
...
public class BreadHttpGetRequest extends AsyncTask<String, Void, String> {

    Catalog catalog = null;
    ArrayList<BreadPart> breadParts = new ArrayList<>();
    public BreadHttpGetRequest (Catalog catalog) {
    ...
    protected String doInBackground(String... params){
        ...
        try {
            ...
            Log.d("test", "k");
            URL myUrl = new URL("http://demo2126335.mockable.io/getbreadproducts");
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            for(int i = 0; i < foodlist.length() ; i++) {
                ...
                BreadPart breadPart = new BreadPart();
                ...
                breadPart.name = name;
                breadPart.price = price;

                breadParts.add(breadPart);
            }
            Log.d("test", "size = "+breadParts.size());
        } catch (JSONException e) {
            Log.d("test", "exeption");
        }

        bread.breadParts= breadParts;
        catalog.start1();
    }
}
