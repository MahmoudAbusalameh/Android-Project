...
import com.example.abusalameh.myapplication.menu.catlogfiles.FoodPart;
...
public class FoodHttpGetRequest extends AsyncTask<String, Void, String> {
    Catalog catalog = null;
    ArrayList<FoodPart> foodParts = new ArrayList<>();
    public FoodHttpGetRequest (Catalog catalog) {
    ...
    protected String doInBackground(String... params){
        ...
        try {
            ...
            Log.d("test", "k");
            URL myUrl = new URL("http://demo2126335.mockable.io/fooditems");
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            for(int i = 0; i < foodlist.length() ; i++) {
                ...
                FoodPart foodPart = new FoodPart();
                ...
                foodPart.name = name;
                foodPart.price = price;

                foodParts.add(foodPart);
            }
            Log.d("test", "size = "+foodParts.size());
        } catch (JSONException e) {
            Log.d("test", "exeption");
        }

        food.foodParts= foodParts;
        catalog.start3();
    }
}
