...
//Using Recycle View for non food

public class RecyclerViewAdapterF extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder>{
    private Context mContext;
    private ArrayList <FoodPart> mData;
    RequestOptions option;

    public RecyclerViewAdapterF(Context mContext, ArrayList<FoodPart> mData) {
