...
//Using Recycle View for bread

public class RecyclerViewAdapterB extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder>{
    private Context mContext;
    private ArrayList <BreadPart> mData;
    RequestOptions option;

    public RecyclerViewAdapterB(Context mContext, ArrayList<BreadPart> mData) {
